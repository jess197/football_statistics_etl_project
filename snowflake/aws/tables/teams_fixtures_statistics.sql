---- ## SERIE A BRAZIL TEAMS FIXTURES STATISTICS BETWWEN 2018 T0 2023 ## ----

SELECT * FROM @MANAGE_DB.EXTERNAL_STAGES.TEAMS_FIXTURES_STATISTICS_STAGE_S3
(file_format => MANAGE_DB.FILE_FORMATS.JSON_FORMAT);

CREATE OR REPLACE TABLE FOOTBALL_DATA.RAW.TEAMS_FIXTURES_STATISTICS(
RAW_FILE VARIANT);
...
SELECT * 
  FROM FOOTBALL_DATA.RAW.TEAMS_FIXTURES_STATISTICS;