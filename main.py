...
def process_teams():
    ...
    uploader.upload_file_to_BlobStorage('teams_brazil/teams.json',json_data)
    ...
    for season in response_league['response'][0]['seasons']:
        ...
        if int(year) >= 2022:
            ...
            for team in response_standings['response'][0]['league']['standings'][0]:
                ...
                uploader.upload_file_to_BlobStorage(f'teams_statistics/{championship}/{season}/{team_name}/statistics.json',json_data)
        else:
            continue
...
def process_standings():
    ...
    for season in response['response'][0]['seasons']:
        ...
        if int(year) >= 2018:
            ...
            uploader.upload_file_to_BlobStorage(f'teams_standings/{year}/standings.json',json_data)
        else:
            continue
    ...
    for season in response['response'][0]['seasons']:
        ...
        if int(year) >= 2018:
            ...
            for team in response_standings['response'][0]['league']['standings'][0]:
                ...
                uploader.upload_file_to_BlobStorage(f'teams_fixtures/{championship}/{season}/{team_name}/fixtures.json',json_data)
        else:
            continue
            ...
            for team in response_standings['response'][0]['league']['standings'][0]:
                ...
                for fixture in response_fixtures['response']:
                    ...
                    if not uploader.blob_exists(file_name):
                        ...
                        uploader.upload_file_to_BlobStorage(file_name,json_data)
                    else:
